...
const ThreeDPotViewModal = ({ onClose, fileList }) => {
  // id: 5,
  // title: '아랫턱',
  ...
  return (
    <>
      <div className="fullPop" style={{ display: 'block', width: '150' }}>
        ...
        <div>
          <R3DViewer style={{ height: '100%', minHeight: 700, minWidth: 1200 }} isEditable={false} layerOn={true} layerAll={layerAll} layerRepo={layerRepo} />
        </div>
      </div>
    </>
  );
...
export default ThreeDPotViewModal;
