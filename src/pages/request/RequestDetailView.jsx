            ...
            <div className="detail">
              ...
              <dl>
                ...
                <dd>
                  ...
                  {params[activeIndex].typeList.value.length > 0 && <Tooths ref={toothsRef} activeIndex={activeIndex} params={params} setParams={setParams} onChange={handleToothsChange} isViewMode={true}/>}
                </dd>
              </dl>
              ...
              {params.length > 0 && (
                <>
                  <dl>
                    ...
                    <UnitSet activeIndex={activeIndex} params={params} setParams={setParams} onRemove={handleToothsRemove} isViewMode={true}/>
                  </dl>
                  <dl>
