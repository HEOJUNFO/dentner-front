...
import { Pagenation, ItemTag, PostsMore, BaseButton } from '@components/common';
              ...
              <ul className='office'>
                <li>
                  ...
                  <div className='listD'>
                    ...
                    <div>
                      <Link className='bMR' to='/centerOfficeView'><span><em>더</em> 자세히보기</span></Link>
                    </div>
                  </div>
                  <span className='right'>
                    <BaseButton label='링크' className='bLink' />
                  </span>
                </li>
                <li>
                  <span className='profileImg'>
