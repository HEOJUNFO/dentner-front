  ...
  return (
    <>
      ...
      <div className='mainVisual'>
        ...
        <div className='img'><img src={sampleProfile} /></div>
      </div>
      {/* 의뢰서 */}
      <div className='mainInquire'>
        <div className='infoAreaTit'>
          <strong><strong>원하는 모드</strong>의 의뢰서를 작성해보세요!</strong>
        </div>
        <div className='go'>
          <div>
            <dl>
            ...
            <Link to='/inquireWrite'>작성하러 가기</Link>
          </div>
          <div>
            <dl>
              <dt>상세모드</dt>
            ...
            <Link to='/inquireDetailWrite'>작성하러 가기</Link>
          </div>
        </div>
      </div>
      {/* CAD 디자인 */}
