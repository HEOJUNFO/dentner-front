  ...
  return (
    <>
      ...
      <div className="mainCad serviceCase">
        ...
        <div className="go">
          <BaseButton style={{ cursor: 'default' }} label={'크라운&캡'} />
          <BaseButton style={{ cursor: 'default' }} label={'인레이(온레이)'} />
          <BaseButton style={{ cursor: 'default' }} label={'프레임'} />
          <BaseButton style={{ cursor: 'default' }} label={'의치 및 배열'} />
          <BaseButton style={{ cursor: 'default' }} label={'스프린트 및 서지컬 가이드'} />
          <BaseButton style={{ cursor: 'default' }} label={'교정'} />
          <BaseButton style={{ cursor: 'default' }} label={'어버트먼트'} />
          <BaseButton style={{ cursor: 'default' }} label={'기타'} />
        </div>
      </div>
      {/* 비용안내 */}
      ...
      <div className="serviceSuggest">
        <div className="infoAreaTit">
          <em>Check!</em>
          <strong>
            <strong>덴트너,</strong> 이런 사람에게 추천해요!
            <br />
          </strong>
        </div>
        <ul>
      ...
      {/* 용어 */}
      <div ref={element} style={{ transform: 'translateY(-100px)' }} />
      <div className="serviceKeyTerms">
        <div className="infoAreaTit">
          <strong>
            <strong>덴트너</strong>의 주요 용어를 알아볼까요?
            <br />
          </strong>
        </div>
        <div className="key">
          ...
          <nav>
            <ul>
              <li className={`${tab === 1 ? 'on' : ''}`}>
                <button onClick={() => handleTab(1)}>간편모드</button>
              </li>
              <li className={`${tab === 2 ? 'on' : ''}`}>
                <button onClick={() => handleTab(2)}>상세모드</button>
              </li>
            </ul>
          </nav>
        </div>
          ...
          <nav>
            <ul>
              <li className={`${tab2 === 1 ? 'on' : ''}`}>
                <button onClick={() => handleTab2(1)}>공개요청</button>
              </li>
              <li className={`${tab2 === 2 ? 'on' : ''}`}>
                <button onClick={() => handleTab2(2)}>지정요청</button>
              </li>
            </ul>
          </nav>
        </div>
