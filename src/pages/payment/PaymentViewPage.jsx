          ...
          <div className="tvs">
            <article>
              <div className="detail">
                <h4 className="noLine">
                  <strong>
                    요청사항 <strong>(선택입력)</strong>
                  </strong>
                </h4>
                <textarea defaultValue={'치자이너에게 요청할 사항을 작성해주세요. (최대 200자)'}></textarea>
              </div>
              <h3 className="pt60 lineCase">내 요청서 정보</h3>
              ...
              <h3 className="pt60 lineCase">결제 내역</h3>
              <div className="detail">
                <div className="mBack">
                  <h4>
                    <strong>보철종류/금액</strong>
                  </h4>
              ...
              <div className="infoNotes">
                <dl>
                  <dt>결제하기 이후 거래 취소 시, 마일리지 차감안내</dt>
                  <dd>
                    ▪️ 치자이너 요청서 접수 전 → 마일리지 전액 환불 <br />
                    ▪️ 치자이너 요청서 접수 후 → 치자이너 취소 승인 후, 마일리지 50% 차감 및 환불 <br />
                    &nbsp;&nbsp;&nbsp;* 치자이너와 소통해주세요 <br />
                    ▪️ 치자이너 CAD파일 업로드 후 → 취소 불가
                  </dd>
                </dl>
                <span className="checkSet">
                  <input type="checkbox" id="checkbox1" />
                  <label htmlFor="checkbox1">
                    <sup>필수항목</sup> 유의 사항을 확인 하였습니다.
                  </label>
                </span>
              </div>
